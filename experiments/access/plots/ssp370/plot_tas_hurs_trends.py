...
flat_values = xr.concat([ub_so_cmip6, lb_so_cmip6, ub_so_emulator, lb_so_emulator,
                         ...
                         ub_land_cmip6, lb_land_cmip6, ub_land_emulator, lb_land_emulator], dim='new')
...
plt.savefig("experiments/access/plots/ssp370/files/tas_hurs_trends.jpg", dpi=300, bbox_inches='tight')