...
from experiments.miroc.plots.ssp245.utils import VARIABLES, load_data
...
# plt.show()
plt.savefig("experiments/miroc/plots/ssp245/files/extremes_bias.jpg", dpi=300, bbox_inches='tight')