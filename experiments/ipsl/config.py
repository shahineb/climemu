...
class ModelConfig:
    ...
    """
    input_size: Tuple[int, int, int] = (3, 143, 144)  # (channels, nlat, nlon)
...
class DataConfig:
    ...
    model_name: str = "IPSL-CM6A-LR"  # Climate model to use
    train_experiments: List[str] = ("piControl", "historical", "ssp126", "ssp245", "ssp370", "ssp585")  # Training experiments
    variables: List[str] = ("tas", "pr")  # Climate variables
