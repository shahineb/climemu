...
from experiments.canesm.plots.piControl.utils import load_data, setup_figure, save_plot, wrap_lon, add_seasonal_coords
...
def create_mollified_plot():
    ...
    sns.histplot(data1, ax=ax, kde=False, stat="density", bins=logbins, color="dodgerblue", label=config.data.model_name, edgecolor=None, alpha=0.5)
