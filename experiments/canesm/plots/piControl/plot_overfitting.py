...
from experiments.canesm.plots.piControl.utils import VARIABLES, load_data, setup_figure, save_plot, wrap_lon
from experiments.canesm.data import load_dataset
...
def compute_regional_data(piControl_diffusion, piControl_cmip6, test_dataset, config):
    """Compute regional data for tas and pr variables."""
...
def create_overfitting_plot():
    ...
    ax.axis("off")
    ax.text(0.5, 0.5, "Temperature", va="center", ha="center", rotation="vertical", fontsize=14, weight="bold")


    ax = fig.add_subplot(gs[1, -4])
    ax.axis("off")
    ax.text(0.5, 0.5, "Precipitation", va="center", ha="center", rotation="vertical", fontsize=14, weight="bold")
