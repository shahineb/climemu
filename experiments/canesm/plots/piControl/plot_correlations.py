...
from experiments.canesm.plots.piControl.utils import load_data, setup_figure, save_plot
...
corr_ds_cmip6 = pixelwise_correlation_maps(piControl_cmip6)
...
def create_correlations_plot():
    ...
    width_ratios = [0.05, 1, 1, 0.01, 0.05]
