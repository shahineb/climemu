...
from paper.access.plots.ssp245.utils import VARIABLES, load_data, setup_figure, save_plot
...
OUTPUT_DIR = 'paper/access/plots/ssp245/files'
DPI = 300
...
def main():
    """Main function to generate portrait plot."""
