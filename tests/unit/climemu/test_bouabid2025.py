"""Tests for Bouabid2026Emulator core functionality."""
...
class TestBouabid2026Emulator:
    ...
    @patch('climemu.emulators.bouabid2026.Bouabid2026Emulator._load_precursor')
    @patch('climemu.emulators.bouabid2026.Bouabid2026Emulator._load_climatology')
    @patch('climemu.emulators.bouabid2026.Bouabid2026Emulator._load_pattern_scaling')
